...
import {MonorepoService} from './services/nodes/monorepo.service';
...
export class WorkflowBuilderApplication extends BootMixin(
  ...
  setUpBinding(): void {
    ...
    this.bind('services.MonorepoService').toClass(MonorepoService);
    ...
    this.bind('services.GoogleAuthService').toClass(GoogleAuthService);
  }
